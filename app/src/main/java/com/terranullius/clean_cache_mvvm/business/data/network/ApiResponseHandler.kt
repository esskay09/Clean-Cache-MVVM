package com.terranullius.clean_cache_mvvm.business.data.network

import com.terranullius.clean_cache_mvvm.business.data.network.NetworkErrors.NETWORK_DATA_NULL
import com.terranullius.clean_cache_mvvm.business.data.network.NetworkErrors.NETWORK_ERROR
